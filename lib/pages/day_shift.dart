...
class DayShift extends StatefulWidget {
  ...
  DayShift({this.auth});
  @override
  _DayShiftState createState() => _DayShiftState();
}

class _DayShiftState extends State<DayShift> {
  static Route<dynamic> route() => MaterialPageRoute(
        builder: (context) => DayShift(),
      );
  ...
  void initState() {
    ...
    getDayRangeData(dateRange[0], dateRange[dateRange.length - 1]);
    getDayRangeListData(dateRange[0], dateRange[dateRange.length - 1]);
    getDayMonthlyListData(
        getFirstDateOfMonth(monthlyDate), getLastDateOfMonth(monthlyDate));
    getDayProductionData(selectedDate);
    getDayRangeEquipmentData(dateRange[0], dateRange[dateRange.length - 1]);
    getDayMonthEquipmentData(
        getFirstDateOfMonth(monthlyDate), getLastDateOfMonth(monthlyDate));
    getDayEquipmentData(selectedDate);
    getDayDailyData(selectedDate).then((value) {
      setState(() {
        isLoading = false;
        isComments = false;
        getData = false;
  ...
  Future<void> _selectDate(BuildContext context, String filter) async {
    if (filter == "Day") {
      ...
      if (picked != null && picked != selectedDate) {
        ...
        isComments = true;
        isComments2 = true;
        await getDayDailyData(picked);
        await getDayProductionData(picked);
        await getDayEquipmentData(picked).then((value) {
          setState(() {
            selectedDate = picked;
            isLoading = false;
            getData = false;
      ...
      if (picked != null && picked.length == 2) {
        ...
        isComments = true;
        isComments2 = true;
        await getDayRangeData(picked[0], picked[picked.length - 1]);
        await getDayRangeListData(picked[0], picked[picked.length - 1]);
        await getDayRangeEquipmentData(picked[0], picked[picked.length - 1])
            .then((value) {
          setState(() {
            dateRange = picked;
            isLoading = false;
      ...
      if (picked != null && picked != monthlyDate) {
        ...
        isComments = true;
        isComments2 = true;
        await getDayMonthData(
            getFirstDateOfMonth(picked), getLastDateOfMonth(picked));
        await getDayMonthlyListData(
            getFirstDateOfMonth(picked), getLastDateOfMonth(picked));
        await getDayMonthEquipmentData(
                getFirstDateOfMonth(picked), getLastDateOfMonth(picked))
            .then((value) {
          setState(() {
            monthlyDate = picked;
          ...
          Column(
            children: <Widget>[
                      ...
                      child: SfCartesianChart(
                          ...
                          series: <CartesianSeries>[
                            ...
                            ColumnSeries<DailyProTarget, String>(
                              name: "Target",
                              dataSource: rangeDayShiftTarget,
              ...
              Padding(
                ...
                child: getComments(rangeDayShiftList),
              ),
            ],
          ),
          Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: getComments2(rangeDayShiftEList),
              ),
            ],
          )
        ],
          ...
          Column(
            children: <Widget>[
                  ...
                  child: Container(
                      ...
                      child: SfCartesianChart(
                          ...
                          series: <CartesianSeries>[
                            ...
                            ColumnSeries<DailyProTarget, String>(
                              name: "Target",
                              dataSource: monthDayShiftTarget,
                              xValueMapper: (DailyProTarget data, _) =>
                                  data.target,
                              yValueMapper: (DailyProTarget data, _) =>
                                  data.value,
              ...
              Padding(
                ...
                child: getComments(monthDayShiftList),
              ),
            ],
          ),
          Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: getComments2(monthDayShiftEList),
              ),
            ],
          )
        ],
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Container(
                    height: 100,
                    child: FutureBuilder<ProductionUpdate>(
                        future: getDayDailyData(selectedDate),
                        builder: (context, snapshot) {
                          return ListView.builder(
                              scrollDirection: Axis.horizontal,
                              itemCount: nameList.length,
                      ...
                      child: SfCartesianChart(
                          ...
                          series: <CartesianSeries>[
                            ...
                            ColumnSeries<DailyProTarget, String>(
                              name: "Target",
                              dataSource:
                                  getTarget2(dayFilter, dayDayShiftList),
                              xValueMapper: (DailyProTarget data, _) =>
                                  data.target,
                              yValueMapper: (DailyProTarget data, _) =>
                                  data.value,
              ...
              Padding(
                ...
                child: getComments(dayDayShiftList),
              ),
            ],
          ),
          Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: getComments2(dayDayShiftEList),
              ),
            ],
          )
        ],
